...
class MissionNormalCard extends StatelessWidget {
  const MissionNormalCard(this.mission, {super.key});
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: "${mission.remainRewardCount}",
                                style: FortuneTextStyle.body3Semibold(color: Colors.white),
                              ),
                              TextSpan(
                                text: "/${mission.totalRewardCount}",
              ...
              children: [
                Flexible(
                  child: LinearPercentIndicator(
                    ...
                    percent: mission.obtainedItemCount / mission.totalItemCount > 1
                        ? 1
                        : mission.obtainedItemCount / mission.totalItemCount,

...
class _CustomerAdViewState extends State<CustomerAdView> {
  ...
  static const _waitingTime = 15;
  String buttonText = FortuneTr.msgButtonActivationCountdown(_waitingTime);
  ...
  void initState() {
    ...
    Timer.periodic(const Duration(seconds: 1), (
      ...
      if (timer.tick >= _waitingTime) {
        ...
        setState(() {
          buttonText = FortuneTr.msgButtonActivationCountdown(_waitingTime - timer.tick);
        });
      }
    });
  }

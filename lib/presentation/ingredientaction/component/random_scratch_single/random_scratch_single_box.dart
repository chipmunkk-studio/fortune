...
class RandomScratchSingleBox extends StatefulWidget {
  const RandomScratchSingleBox({
    super.key,
  ...
  @override
  State<RandomScratchSingleBox> createState() => _RandomScratchSingleBoxState();
}

class _RandomScratchSingleBoxState extends State<RandomScratchSingleBox> {

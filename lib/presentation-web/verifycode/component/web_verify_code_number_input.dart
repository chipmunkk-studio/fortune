...
class WebVerifyCodeNumberInput extends StatefulWidget {
  const WebVerifyCodeNumberInput({
    super.key,
  ...
  @override
  State<WebVerifyCodeNumberInput> createState() => _WebVerifyCodeNumberInputState();
}

class _WebVerifyCodeNumberInputState extends State<WebVerifyCodeNumberInput> {
  Timer? timer;
          ...
          Stack(
            children: [
              ...
              Positioned(
                ...
                top: 0,
                bottom: 0,
                child: BlocConsumer<WebVerifyCodeBloc, WebVerifyCodeState>(
                  ...
                  builder: (BuildContext context, WebVerifyCodeState state) {
                    return Container(

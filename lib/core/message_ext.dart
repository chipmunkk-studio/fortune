...
abstract class FortuneTr {
  ...
  static final msgNoHasCoin = tr('msgNoHasCoin');
  static final msgCoinPick = tr('msgCoinPick');
  ...
  static final msgMyMissionStatus = tr('msgMyMissionStatus');
  ...
  static final msgInvalidMission = tr('msgInvalidMission');
  ...
  static final msgRecentNotifications = tr('msgRecentNotifications');
